 ...
 */
  ...
  public static readonly SPECIAL_GROUP: { key: string, text: string, items: number[] }[] = [
    ...
    { key: '59-1', text: '1', items: [242, 367, 368, 369, 370, 196, 256, 257, 389, 195, 419, 420, 233, 277, 158, 159, 353, 197, 198, 205, 206, 254, 255, 375, 421, 422, 371, 414, 415, 171, 304, 163, 164, 215] },
