 ...
 */
  ...
  public static readonly SPECIAL_GROUP: { key: string, text: string, items: number[], isOnlyAB?: boolean, isOnlyShip?: boolean }[] = [
    ...
    { key: '61-4', text: 'A', isOnlyAB: true, items: [312, 218, 396] },
    { key: '61-4', text: 'B', isOnlyAB: true, items: [459, 201, 311, 395, 270, 552] },
    { key: '61-4', text: 'C', isOnlyAB: true, items: [388, 170, 493, 270] },
    { key: '61-4', text: 'A', isOnlyShip: true, items: [238, 239, 523, 118, 254, 255, 338, 339, 473, 257, 344, 345, 373, 374, 389, 545] },
    { key: '61-4', text: 'B', isOnlyShip: true, items: [469, 540, 521, 552, 557, 558, 237, 322, 323, 490] },
    { key: '61-5', text: 'A', isOnlyAB: true, items: [312, 218, 396] },
    { key: '61-5', text: 'B', isOnlyAB: true, items: [201, 311, 395, 552] },
    { key: '61-5', text: 'C', isOnlyAB: true, items: [388, 170, 493, 269, 270] },
    { key: '61-5', text: 'A', isOnlyShip: true, items: [238, 239, 523, 118, 254, 255, 338, 339, 473, 257, 344, 345, 373, 374, 389, 545] },
