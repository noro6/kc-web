 ...
 */
  ...
  public static readonly SPECIAL_GROUP: { key: string, text: string, items: number[] }[] = [
    ...
    { key: 'Saury', text: 'Saury', items: [44, 45, 287, 288, 377, 472, 47, 69, 324, 325, 326, 327, 70, 451, 74, 129, 138, 140, 178, 242, 243, 244, 258, 259, 260, 261, 262, 412, 438, 25, 59, 102, 115, 118, 163, 171, 238, 239, 304, 370, 371, 414, 415, 469, 471, 510, 515, 26, 62, 79, 80, 81, 194, 207, 208, 237, 322, 323, 367, 368, 369, 490] },
  ];
