 ...
 */
  ...
  public static readonly ANTIAIR_CUTIN = [
    ...
    {
      id: 41, text: '41種', rateBonus: 1.65, c1: 5, c2: 4, rate: 60, remarks: 'Atlanta',
    },
  ];
  ...
  public static readonly MAPS = [
    { value: 11, text: '1: 鎮守府正面海域' },
    { value: 12, text: '2: 南西諸島沖' },
    { value: 13, text: '3: 製油所地帯沿岸' },
    { value: 14, text: '4: 南西諸島防衛線' },
    { value: 15, text: '5: 鎮守府近海' },
    { value: 16, text: '6: 鎮守府近海航路' },
    { value: 21, text: '1: 南西諸島近海' },
    { value: 22, text: '2: バシー海峡' },
    { value: 23, text: '3: 東部オリョール海' },
    { value: 24, text: '4: 沖ノ島海域' },
    { value: 25, text: '5: 沖ノ島沖' },
    { value: 31, text: '1: モーレイ海' },
    { value: 32, text: '2: キス島沖' },
    { value: 33, text: '3: アルフォンシーノ方面' },
    { value: 34, text: '4: 北方海域全域' },
    { value: 35, text: '5: 北方AL海域' },
    { value: 41, text: '1: ジャム島沖' },
    { value: 42, text: '2: カレー洋海域' },
    { value: 43, text: '3: リランカ島' },
    { value: 44, text: '4: カスガダマ島' },
    { value: 45, text: '5: カレー洋リランカ島沖' },
    { value: 51, text: '1: 南方海域前面' },
    { value: 52, text: '2: 珊瑚諸島沖' },
    { value: 53, text: '3: サブ島沖海域' },
    { value: 54, text: '4: サーモン海域' },
    { value: 55, text: '5: サーモン海域北方' },
    { value: 61, text: '1: 中部海域哨戒線' },
    { value: 62, text: '2: MS諸島沖' },
    { value: 63, text: '3: グアノ環礁沖海域' },
    { value: 64, text: '4: 中部北海域ピーコック島沖' },
    { value: 65, text: '5: KW環礁沖海域' },
    { value: 71, text: '1: ブルネイ泊地沖' },
    { value: 72, text: '2: タウイタウイ泊地沖' },
    { value: 73, text: '3: ペナン島沖' },
    { value: 74, text: '4: 昭南本土航路' },
    { value: 461, text: '1: マカッサル沖/バリ島沖' },
    { value: 462, text: '2: ジャワ沖/ダーウィン沖' },
    { value: 463, text: '3: ジャワ海/スラバヤ沖' },
    { value: 464, text: '4: バタビア沖' },
    { value: 465, text: '5: ダバオ沖/太平洋南西部' },
    { value: 466, text: '6: ソロモン諸島沖' },
    { value: 471, text: '1: 期間限定海域:マニラ沖' },
    { value: 481, text: '1: オホーツク海千島列島沖' },
    { value: 482, text: '2: 南西諸島沖' },
    { value: 483, text: '3: 四国沖/九州西方五島列島沖' },
    { value: 484, text: '4: 小笠原諸島沖' },
    { value: 485, text: '5: ニューブリテン島沖/ソロモン諸島西部沖' },
    { value: 486, text: '6: ソロモン諸島沖' },
    { value: 487, text: '7: ソロモン諸島沖/サンタ・クルーズ諸島沖' },
    { value: 491, text: '1: 地中海マルタ島沖' },
    { value: 492, text: '2: バレンツ海' },
    { value: 493, text: '3: ノルウェー北岬沖/北極海' },
    { value: 494, text: '4: ルソン島沖/オルモック沖' },
    { value: 501, text: '1: 台湾/南沙諸島/比島方面沖' },
    { value: 502, text: '2: ソロモン方面/レンネル島沖' },
    { value: 503, text: '3: タサファロング泊地沖' },
    { value: 504, text: '4: ラバウル沖/ビスマルク諸島沖/ソロモン諸島沖' },
    { value: 505, text: '5: アイアンボトムサウンド' },
    { value: 511, text: '1: アレクサンドリア沖/クレタ島沖' },
    { value: 512, text: '2: 地中海/マルタ島沖/ティレニア海' },
    { value: 513, text: '3: ジブラルタル沖/地中海/マルタ島沖' },
    { value: 521, text: '1: 三陸沖/北海道根室半島沖' },
    { value: 522, text: '2: 昭南方面～本土航路' },
    { value: 523, text: '3: 八丈島沖/房総半島東方沖' },
  ];
}
