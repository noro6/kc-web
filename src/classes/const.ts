 ...
 */
  ...
  public static readonly SPECIAL_GROUP: { key: string, text: string, items: number[] }[] = [
    ...
    { key: '57-5', text: 'A', items: [401, 405, 431, 432, 459, 354, 178] },
    { key: '57-5', text: 'B', items: [433, 479, 250, 251, 253, 480] },
    { key: '57-5', text: 'A', items: [158, 159, 353, 249, 184, 189, 510] },
    { key: '57-5', text: 'B', items: [474, 475, 476, 481, 473, 252, 434, 435, 471, 423] },
