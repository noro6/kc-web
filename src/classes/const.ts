 ...
 */
  ...
  public static readonly SPECIAL_GROUP: { key: string, text: string, items: number[] }[] = [
    ...
    { key: '57-5', text: 'A1', items: [178] },
    { key: '57-5', text: 'A2', items: [459, 242, 256, 257, 233, 277, 197, 198, 205, 206, 254, 255, 375, 389, 195, 419, 420, 158, 159, 353, 354] },
    { key: '57-5', text: 'A3', items: [431, 432, 243, 188, 316, 248, 64, 305, 306, 422, 249, 184] },
    { key: '57-5', text: 'A4', items: [405, 433, 244, 424, 425, 189, 406] },
    { key: '57-5', text: 'B1', items: [250, 251, 253] },
    { key: '57-5', text: 'B3', items: [473, 474, 475] },
    { key: '57-5', text: 'B4', items: [252, 434, 435, 423, 476, 479, 480, 481] },
    { key: '57-5', text: '2', items: [367, 368, 369, 370, 414, 415, 371] },
    { key: '57-5', text: '3', items: [194, 510] },
    { key: '57-5', text: '4', items: [471, 515] },
