 ...
 */
  ...
  public static readonly EXPANDED_SPECIAL_ITEM = [
    ...
    { itemId: 413, shipApi: [21, 22, 23, 24, 25, 53, 54, 55, 56, 57, 58, 99, 100, 101, 113, 114, 118, 119, 137, 138, 139, 140, 141, 146, 158, 159, 160, 183, 200, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 289, 290, 305, 306, 307, 314, 321, 330, 346, 357, 421, 422, 423, 487, 488, 532, 533, 537, 538, 542, 543, 547, 649, 652, 657, 662, 663, 668] },
  ];
  ...
  public static readonly SHIP_ITEM_LINK = [
    ...
    { id: 533, itemType: [1, 5, 12, 13, 14, 15, 17, 20, 21, 23, 29, 30, 33, 34, 36, 37, 39, 43] },
    ...
    { id: 538, itemType: [1, 5, 12, 13, 14, 15, 17, 20, 21, 23, 27, 29, 30, 33, 34, 36, 37, 39, 40, 43] },
    ...
    { id: 716, itemType: [1, 5, 12, 14, 15, 17, 20, 21, 23, 24, 29, 30, 33, 36, 37, 39, 43] },
    { id: 717, itemType: [4, 6, 7, 12, 13, 14, 15, 16, 17, 20, 21, 23, 25, 26, 27, 35, 36, 40, 43, 44, 50] },
    { id: 718, itemType: [1, 5, 12, 14, 15, 17, 20, 21, 23, 24, 29, 30, 33, 36, 37, 39, 43] },
    ...
    { id: 900, itemType: [12, 14, 15, 16, 17, 20, 21, 23, 26, 27, 35, 36, 43, 44, 50] },
    { id: 908, itemType: [1, 5, 12, 14, 15, 17, 20, 21, 23, 24, 29, 30, 33, 36, 37, 39, 43, 46] },
  ];
  ...
  public static readonly MAPS = [
    ...
    { value: 531, text: '九州沖/南西諸島方面' },
    { value: 532, text: '高雄警備府～比島北部沖' },
    { value: 533, text: '関東/太平洋沖' },
    { value: 534, text: '昭南～マニラ航路' },
