...
export interface MasterShip { id: number, album: number, type: number, name: string, s_count: number, slots: number[], final: number, orig: number, ver: number, range: number, type2: number, hp: number, hp2: number, max_hp: number, fire: number, torpedo: number, anti_air: number, armor: number, luck: number, max_luck: number, min_scout: number, scout: number, min_asw: number, asw: number, min_avoid: number, avoid: number, speed: number, before: number, next_lv: number, sort: number, fuel: number, ammo: number }
